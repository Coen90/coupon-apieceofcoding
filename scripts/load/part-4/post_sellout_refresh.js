// 시나리오 ②: 매진 후 새로고침 요청 급증. 매진 상태 효과 측정.
//
// 사전 조건: 재고를 100 장으로 만든 쿠폰을 만든 뒤 100 명이 발급해 매진시킨다.
// 그 다음 30 초 동안 4,000 req/s 의 발급 요청 급증을 보낸다.
//
// 측정 포인트:
//   - 4-0 ~ 4-1c (매진 상태 없음): 모든 요청이 Lua 까지 들어와 -1 (매진) 응답.
//   - 4-2 (매진 상태 적용): 컨트롤러 진입 직후 fast-path 에서 잘려 Lua 호출 0 수렴.
